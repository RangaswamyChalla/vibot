...
| 🟢 Low | `tts_service.synthesize()` blocks event loop | `api/routes/voice.py:210` | ✅ Fixed | Consistently using `run_in_executor` in API |
| 🟢 Low | Dead-letter jobs accumulate indefinitely | `pipeline/queue.py:49` | ✅ Fixed | Added TTL purge for dead-letter persistence |
